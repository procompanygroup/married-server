                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ url('admin/client/delete', $client->id) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" id="del-{{ $client->id }}"
                                                class="btn btn-danger btn-sm delete" data-toggle="modal"
                                                data-target="#modal-delete" title="Delete"> <i class="fas fa-trash">
                                                </i>حذف</button>
                                        </form>
    ...
    <div class="modal fade" id="modal-addspecial">
        <div class="modal-dialog  modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between" style="border-top: 0px solid  ">
                    <button class="btn ripple btn-secondary btn-cancel-modal" data-dismiss="modal"
                        type="button">{{ __('general.cancel', [], 'ar') }}</button>
