...
@section('breadcrumb')الترجمة@endsection
@section('content')
        ...
        <div class="row backgroundW p-4 m-3">
            <div class="container">
                ...
                <div class="form-group btn-create  justify-content-end" style="display: flex">
                    <a href="{{url('admin/translate/create')}}" class="btn btn-primary">جديد</a>
                </div>
            </div>
                        ...
                        @forelse  ($list as $item)
                            <tr>
                                ...
                                <td style="width: 50px">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <a href="{{url('admin/translate/edit', $item->id)}}"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                        <div class="col-sm-2">
                                                <form method="POST" action="{{url('admin/translate/destroy', $item->id)}}" >
                                                    @csrf
                                                    @method('DELETE')
