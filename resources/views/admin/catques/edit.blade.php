        ...
        <div class="card-body  row">
            <div class="col-lg-12">
                <form class="form-horizontal" name="create_form" method="POST"
                    action="{{ route('categoryques.update', $category->id) }}" enctype="multipart/form-data"
                    id="create_form">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-controll" name="title" id="title" placeholder="* الاسم"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-controll" rows="3" name="desc" id="desc" placeholder="الوصف">{{ $category->desc }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-controll" name="slug" id="slug" placeholder="الرابط"
                                value="{{ $category->slug }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-controll" rows="2" name="metakey" id="metakey" placeholder="الكلمات المفتاحية">{{ $category->meta_key }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 custom-control custom-switch ">
                            <input type="checkbox" class="custom-control-input" id="status" name="status" value="1"
                                @if ($category->status == '1') @checked(true) @endif>
