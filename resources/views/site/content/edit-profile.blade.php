        ...
        <section class=" content-sec col-lg-7 col-md-6">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="email-block">
                                ...
                                <td><input type="email" class="form-control" name="email" value="{{$client->client->email }}"
                                        readonly="readonly"></td>
                                <td class="actions">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group"><label>مكان الإقامة <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                @foreach ($prop_group['countries'] as $country)
                                    <option value="{{ $country->id }}" @if ($client->residence->country_id== $country->id) @selected(true)@endif>{{ $country->name_ar }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 form-group"><label>الجنسية <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                @foreach ($prop_group['countries'] as $country)
                                    <option value="{{ $country->id }}" @if ($client->nationality->country_id== $country->id) @selected(true)@endif >{{ $country->name_ar }}</option>
                                @endforeach
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group"><label>نوع الزواج <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                @foreach ($prop_group['wife_num']['optionsvalues'] as $family_options)
                                    <option value="{{ $family_options['id'] }}" @if ($client->wife_num->option_id==$family_options['id'] ) @selected(true)@endif  >
                        ...
                        <div class="col-md-6 form-group"><label>الحالة العائلية <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                @foreach ($prop_group['family_status']['optionsvalues'] as $family_options)
                                    <option value="{{ $family_options['id'] }}" @if ($client->family_status->option_id==$family_options['id'] ) @selected(true)@endif >
                                        {{ $family_options['tr_title'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 form-group"><label>نوع الزواج <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                @foreach ($prop_group['wife_num_female']['optionsvalues'] as $family_options)
                                    <option value="{{ $family_options['id'] }}" @if ($client->wife_num_female->option_id==$family_options['id'] ) @selected(true)@endif  >
                                        {{ $family_options['tr_title'] }}</option>
                                @endforeach
                            </select>
                                    </div>
                        ...
                        <div class="col-md-6 form-group"><label>الحالة العائلية <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                @foreach ($prop_group['family_status_female']['optionsvalues'] as $family_options)
                                    <option value="{{ $family_options['id'] }}" @if ($client->family_status_female->option_id==$family_options['id'] ) @selected(true)@endif >
                                        {{ $family_options['tr_title'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 form-group"><label>تاريخ الميلاد  <sup>*</sup></label>
                            <div id="birthdatepicker" class="input-group date " data-date-format="dd-mm-yyyy">
                                <input class="form-control" name="birthdate" id="birthdate" type="text" value="{{ $birthdateStr }}" />
                        ...
                        <div class="col-md-6 form-group"><label>عدد الأطفال <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required dropup">
                                ...
                                <option value="0" @if ($client->children_num->val==0 ) @selected(true)@endif  >بدون أطفال</option>
                                @php
                                    $i = 0;
                                @endphp
                                @for ($i = 1; $i <= 10; $i++)
                                    <option value="{{ $i }}" @if ($client->children_num->val==$i ) @selected(true)@endif  >{{ $i }}</option>
                                @endfor
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group"><label>الوزن (كغ) <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                @endphp
                                @for ($i = 40; $i <= 200; $i++)
                                    <option value="{{ $i }}" @if ($client->weight->val==$i ) @selected(true)@endif>{{ $i }}</option>
                                @endfor
                            </select>
                            </div>
                        </div>
                        <div class="col-md-6 form-group"><label>الطول (سم) <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                @endphp
                                @for ($i = 110; $i <= 225; $i++)
                                    <option value="{{ $i }}" @if ($client->height->val==$i ) @selected(true)@endif>{{ $i }}</option>
                                @endfor
                            </select>
                            </div>
                        </div>
                        <div class="col-md-6 form-group"><label>لون البشرة <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                <option value="{{ $skin['id'] }}"  @if ($client->skin->option_id==$skin['id'] ) @selected(true)@endif>
                        ...
                        <div class="col-md-6 form-group"><label>بنية الجسم<sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                <select
                                           ...
                                           <option value="{{ $body['id'] }}" @if ($client->body->option_id==$body['id'] ) @selected(true)@endif>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group"><label>التدين <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                <option value="{{ $religiosity['id'] }}"  @if ($client->religiosity->option_id==$religiosity['id'] ) @selected(true)@endif>
                        ...
                        <div class="col-md-6 form-group"><label>الصلاة <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                <option value="{{ $prayer['id'] }}" @if ($client->prayer->option_id==$prayer['id'] ) @selected(true)@endif>
                        ...
                        <div class="col-md-6 form-group"><label>التدخين <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                <option value="{{ $smoking['id'] }}"  @if ($client->smoking->option_id==$smoking['id'] ) @selected(true)@endif>
                        ...
                        <div class="col-md-6 form-group"><label>اللحية <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                <option value="{{ $beard['id'] }}" @if ($client->beard->option_id==$beard['id'] ) @selected(true)@endif>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group"><label>المستوى التعليمي <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                <option value="{{ $education['id'] }}" @if ($client->education->option_id==$education['id'] ) @selected(true)@endif>
                        ...
                        <div class="col-md-6 form-group"><label>الوضع المادي <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                <select name="financial" id="financial"
                                                ...
                                                <option value="{{ $financial['id'] }}" @if ($client->financial->option_id==$financial['id'] ) @selected(true)@endif>
                        ...
                        <div class="col-md-6 form-group"><label>مجال العمل <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big required">
                                ...
                                <option value="{{ $work['id'] }}" @if ($client->work->option_id==$work['id'] ) @selected(true)@endif>{{ $work['tr_title'] }}</option>
                            @endforeach
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 form-group"><label>{{$prop_group['income']['tr_title']}}<sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big dropup">
                                <select name="income" id="income"
                                                ...
                                                <option value="{{ $income['id'] }}" @if ($client->income->option_id==$income['id'] ) @selected(true)@endif>{{ $income['tr_title'] }}</option>
                                            @endforeach
                                            </select>
                        ...
                        <div class="col-md-6 form-group"><label>الحالة الصحية <sup>*</sup></label>
                            <div class="dropdown bootstrap-select std_select std_select_big">
                                ...
                                <option value="{{ $health['id'] }}" @if ($client->health->option_id==$health['id'] ) @selected(true)@endif>{{ $health['tr_title'] }}</option>
                            @endforeach
                            </select>
                            </div>
                        </div>
            ...
            <div class=" input-block bg-white p-4 rounded shadow box-form">
                ...
                <p><strong>يرجى الكتابة بطريقة جادة. يمنع كتابة البريد الإلكتروني أو رقم الهاتف في هذا
                        المكان</strong></p>
                <div class="row">
                    <div class="col-md-12"><textarea name="partner" id="partner" class="form-control">{{ $client->partner->val }}</textarea></div>
                </div>
            ...
            <div class=" input-block bg-white p-4 rounded shadow box-form">
                ...
                <p><strong>يرجى الكتابة بطريقة جادة. يمنع كتابة البريد الإلكتروني أو رقم الهاتف في هذا
                        المكان</strong></p>
                <div class="row">
                    <div class="col-md-12"><textarea name="aboutMe" class="form-control">{{ $client->about_me->val }}</textarea></div>
                </div>
            ...
            <div class=" input-block bg-white p-4 rounded shadow box-form  box-form-last">
                ...
                <div class="row">
                    <div class="col-md-6 form-group"><label>الاسم الكامل <sup>*</sup></label>   
                        <input class="form-control  " name="first_name" id="first_name" value="{{ $client->client->first_name}}"
                        placeholder="اسمك الكامل">
                    </div>
                    <div class="col-md-6 form-group"><label>رقم الجوال <sup>*</sup></label> 
                        <input
                        class="form-control " name="mobile" id="mobile" value="{{ $client->client->mobile}}"
