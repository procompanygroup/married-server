                    ...
                    <div class="edit-details__content">
                        <div class="input-block edit-block">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4  sm-3  text-center">
                                    ...
                                    <button class="btn-del-photo" data-original-title="" title="" data-toggle="modal"
                                        data-target="#favoriteModal"><i class="bi bi-trash"></i></button>
@endif
                                </div>
                ...
                <div class=" input-block bg-white p-4 rounded shadow box-form show-block">
                    ...
                    <div class="edit-details__content">
                                    ...
                                    <ul class="hor ver">
                                        <li>
                                            <div class="btf-control checkbox-control">
                                                <input type="radio" name="client_group" value="0" id="client_group-0"
                                                    class="btf-checkbox" checked>
                                        ...
                                        <li>
                                            <div class="btf-control checkbox-control">
                                                <input type="radio" name="client_group" value="1" id="my-fave"
                                                    class="btf-checkbox">
                                                <label for="my-fave" class="btf-label "> أعضاء من قائمة إهتمامي<span>1
                                                        عضو</span></label>
                                            </div>
                                        </li>
                                                ...
                                                <li>
                                                    <div class="btf-control checkbox-control">
                                                        <input type="checkbox" name="fav[]" value="0"
                                                            id="fav-{{ $client['client']->id }}" class="btf-checkbox"  >
                                                        <label for="fav-{{ $client['client']->id }}" class="btf-label  ">
                                                    <div class="data">
                                                        ...
                                                        <div class="secondary-data">
                                                            ...
                                                            <span class="separator-dash">-</span>
                                                            <span class="user-residency" dir="auto">الاقامة:
                                                                <strong
                        ...
                        <div class="submit-block text-center one-box">
                            <button type="button" id="btn-submit-img" class="btn  btn-primary "> حفظ التعديلات </button>
                        </div>
                    </div>
 
                </div>
                @endif
                <form action="{{ url($lang, 'delete-image') }}" id="form-del-image" name="form-del-image" method="post"
                    autocomplete="off">
                    @csrf
                </form>
            </section>
