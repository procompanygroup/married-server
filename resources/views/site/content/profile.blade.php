                        ...
                        <div class="dashboard-page__block dashboard-page__block--equal block-counters">
                            <div class="row">
                                <div class="col"><a href="{{ url($lang,'who-like-me') }}">
                                         ...
                                         <h6 dir="auto"> يوجد <strong>({{ $counts_arr['who_like_me_count'] }})</strong> عضو مهتم بك </h6>
                                         @else
                                ...
                                <div class="col"><a href="{{ url($lang,'who-visited-me') }}">
                                    ...
                                    <h6 dir="auto"> يوجد <strong>({{ $counts_arr['who_visited_me_today_count'] }})</strong> عضو زار ملفك اليوم </h6>
                                    @else
                                ...
                                <div class="col"><a href="{{ url($lang.'/members','image') }}">
                                    <i style="font-size: 50px; color:#da4761;" class="bi bi-images"></i>                                        
                                        ...
                                        <h6 dir="auto"> يوجد <strong>({{ $counts_arr['show_image_count'] }})</strong> عضو أعطاك صلاحية مشاهدة صورته </h6>
                                        @else
